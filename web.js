...
(function () {
  ...
  var WEB_I18N = {
    ...
    "Fill in your Journal carefully once. From the next day on, you'll find this blue button in the Journal — one click copies yesterday's entry into today. You'll also find it when you confirm your daily medication from its alarm or notification — one click there logs your day too. And if your routine follows the app's advice, every click means something bigger: you've built another good day. Building good days — that's Chronic Friends.": {
      es: "Rellena bien tu Journal una sola vez. Desde el día siguiente encontrarás este botón azul en el Diario — un clic copia el registro de ayer en el día de hoy. También lo encontrarás al confirmar tu medicación diaria desde su alarma o notificación — un clic ahí también registra tu día. Y si tu rutina sigue los consejos de la app, cada clic significa algo más grande: has construido otro buen día. Building good days — eso es Chronic Friends.",
      ca: "Omple bé el teu Journal una sola vegada. Des de l'endemà trobaràs aquest botó blau al Diari — un clic copia el registre d'ahir al dia d'avui. També el trobaràs en confirmar la teva medicació diària des de la seva alarma o notificació — un clic allà també registra el teu dia. I si la teva rutina segueix els consells de l'app, cada clic significa una cosa més gran: has construït un altre bon dia. Building good days — això és Chronic Friends.",
      fr: "Remplissez bien votre Journal une seule fois. Dès le lendemain, vous trouverez ce bouton bleu dans le Journal — un clic copie l'entrée d'hier dans la journée d'aujourd'hui. Vous le retrouverez aussi en confirmant votre médication quotidienne depuis son alarme ou sa notification — un clic là aussi enregistre votre journée. Et si votre routine suit les conseils de l'app, chaque clic veut dire quelque chose de plus grand : vous avez construit un autre bon jour. Building good days — c'est ça, Chronic Friends.",
      de: "Fülle dein Journal einmal sorgfältig aus. Ab dem nächsten Tag findest du diesen blauen Button im Journal — ein Klick kopiert den gestrigen Eintrag in den heutigen Tag. Du findest ihn auch, wenn du deine tägliche Medikation über ihren Wecker oder ihre Benachrichtigung bestätigst — auch dort trägt ein Klick deinen Tag ein. Und wenn deine Routine den Empfehlungen der App folgt, bedeutet jeder Klick etwas Größeres: Du hast wieder einen guten Tag gebaut. Building good days — das ist Chronic Friends.",
      it: "Compila bene il tuo Journal una sola volta. Dal giorno dopo troverai questo pulsante blu nel Diario — un clic copia la registrazione di ieri nel giorno di oggi. Lo troverai anche quando confermi la tua terapia quotidiana dalla sua sveglia o notifica — anche lì un clic registra la tua giornata. E se la tua routine segue i consigli dell'app, ogni clic significa qualcosa di più grande: hai costruito un altro buon giorno. Building good days — questo è Chronic Friends.",
      pt: "Preenche bem o teu Journal uma só vez. A partir do dia seguinte vais encontrar este botão azul no Diário — um clique copia o registo de ontem para o dia de hoje. Também o vais encontrar ao confirmar a tua medicação diária a partir do alarme ou da notificação — um clique aí também regista o teu dia. E se a tua rotina segue os conselhos da app, cada clique significa algo maior: construíste mais um bom dia. Building good days — isso é o Chronic Friends.",
      zh: "认真填写一次日记（Journal）。从第二天起，你会在日记（Journal）里看到这个蓝色按钮——一键就能把昨天的记录复制到今天。当你通过每日用药的闹钟或通知确认服药时，也会看到这个蓝色按钮——在那里点一下，同样能记录你的一天。如果你的日常按照应用的建议来安排，每一次点击都意味着更重要的事：你又建成了美好的一天。Building good days —— 这就是 Chronic Friends。",
      ja: "Journalを一度だけていねいに記入しましょう。翌日からは、Journalの中にこの青いボタンが現れます。ワンクリックで昨日の記録が今日にコピーされます。毎日のお薬をアラームや通知から確認するときにも、この青いボタンが表示され、そこでのワンクリックでもその日を記録できます。アプリのアドバイスに沿った習慣を続ければ、そのワンクリックはもっと大きな意味を持ちます。また一つ、良い一日を築けたということ。Building good days — それがChronic Friendsです。",
      ko: "Journal을 한 번만 정성껏 작성하세요. 다음 날부터 Journal에서 이 파란 버튼을 볼 수 있습니다 — 클릭 한 번으로 어제의 기록이 오늘로 복사됩니다. 매일 복용하는 약을 알람이나 알림에서 확인할 때도 이 파란 버튼이 나타나며, 거기서의 클릭 한 번으로도 하루가 기록됩니다. 앱의 조언에 맞춰 루틴을 만들어 가면, 클릭 한 번은 더 큰 의미가 됩니다. 또 하나의 좋은 하루를 만들어냈다는 뜻이니까요. Building good days — 그것이 Chronic Friends입니다.",
      hi: "अपना Journal एक बार अच्छी तरह भरें। अगले दिन से यह नीला बटन आपको Journal में मिलेगा — एक क्लिक में कल की एंट्री आज में कॉपी हो जाती है। जब आप अपनी रोज़ की दवा उसके अलार्म या नोटिफ़िकेशन से कन्फ़र्म करते हैं, तब भी यह नीला बटन दिखता है — वहाँ एक क्लिक से भी आपका दिन दर्ज हो जाता है। और अगर आपकी दिनचर्या ऐप की सलाह के अनुसार है, तो हर क्लिक का मतलब कुछ बड़ा है: आपने एक और अच्छा दिन बनाया है। Building good days — यही है Chronic Friends।",
      id: "Isi Journal-mu dengan baik satu kali saja. Mulai hari berikutnya, kamu akan menemukan tombol biru ini di Journal — sekali klik menyalin catatan kemarin ke hari ini. Kamu juga akan menemukannya saat mengonfirmasi obat harianmu dari alarm atau notifikasinya — sekali klik di sana juga mencatat harimu. Dan jika rutinitasmu mengikuti saran aplikasi, setiap klik berarti sesuatu yang lebih besar: kamu telah membangun satu hari baik lagi. Building good days — itulah Chronic Friends.",
      tr: "Journal'ını bir kez özenle doldur. Ertesi günden itibaren bu mavi butonu Journal'da bulursun — tek tık dünün kaydını bugüne kopyalar. Günlük ilacını alarmından veya bildiriminden onaylarken de bu mavi butonu görürsün — oradaki tek tık da gününü kaydeder. Rutinin uygulamanın önerilerine uyuyorsa her tık daha büyük bir anlam taşır: bir iyi gün daha inşa ettin. Building good days — Chronic Friends budur.",
      ru: "Заполните свой Journal внимательно один раз. Со следующего дня вы найдёте эту синюю кнопку в Journal — один клик копирует вчерашнюю запись в сегодняшний день. Вы также увидите её, подтверждая ежедневный приём лекарства из будильника или уведомления — один клик там тоже записывает ваш день. И если ваш распорядок следует советам приложения, каждый клик значит нечто большее: вы построили ещё один хороший день. Building good days — в этом весь Chronic Friends.",
  ...
  var ROUTINE_BODY = "Fill in your Journal carefully once. From the next day on, you'll find this blue button in the Journal — one click copies yesterday's entry into today. You'll also find it when you confirm your daily medication from its alarm or notification — one click there logs your day too. And if your routine follows the app's advice, every click means something bigger: you've built another good day. Building good days — that's Chronic Friends.";
  function maybeShowRoutineTip() {
    ...
    /* réplica del banner azul REAL del Journal (pedido por Gerhard: que el
       usuario vea el botón tal cual lo va a encontrar) */
    var demo = document.createElement('div');
    demo.textContent = tr('Same routine as yesterday?') + ' ' + tr('Save time');
    demo.style.cssText = 'margin:4px auto 14px;max-width:340px;padding:14px 18px;border-radius:22px;background:linear-gradient(180deg,#4a6be0,#3350c8);color:#fff;font-size:14.5px;font-weight:800;text-align:center;box-shadow:0 10px 24px rgba(37,62,167,.45);';
    var body = document.createElement('div');
    ...
    btn.onclick = done;
    card.appendChild(icon); card.appendChild(title); card.appendChild(demo); card.appendChild(body); card.appendChild(btn);
    wrap.appendChild(card);
