(function(){/* ===================================================================
   ...
   • Copy is factual (COPY RULES): "[Name], [dose] — taken at 08:12" /
     "[Name] — skipped". No judgments, no totals, no streaks. MED12: for
     a dose whose real amount was written down (insulin units), that
     amount takes the place of the fixed dose text — it is the fact.
